...
[![Replit Ready to Run](https://img.shields.io/badge/Replit-Ready_to_Run-informational?logo=replit&labelColor=white)](https://replit.com/@DiogoAntao/UAb-Streaming-Platform-Classes)
...
## Compile
	javac -d ./out src/Main.java src/Subscriber.java src/Video.java src/Visualization.java
...
Run it on Replit [here](https://replit.com/@DiogoAntao/UAb-Streaming-Platform-Classes).
